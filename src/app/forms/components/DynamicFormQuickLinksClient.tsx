...
// Icon map for dynamic form sections
...
interface DynamicFormQuickLinksClientProps {
  formId: string;
  responseId?: string;
  formTemplate: FormTemplate;
}

export function DynamicFormQuickLinksClient({
  formId,
  responseId,
  formTemplate,
}: DynamicFormQuickLinksClientProps) {
