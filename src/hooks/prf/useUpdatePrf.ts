...
import { FormResponseUpdateDto, SectionStatusUpdateDto } from "@/types/form-template";
...
export const updateCaseDetails = async (
  ...
  const payload: FormResponseUpdateDto = {
    fieldResponses: [
      { fieldDefinitionId: "fb769988-ea1e-4d4d-b995-6417abb89734", value: String(data.regionDistrict || "") },
      { fieldDefinitionId: "538f44c5-4140-4795-99e3-9d8e8255892f", value: String(data.base || "") },
      { fieldDefinitionId: "7285441d-d1f0-4d33-91cf-2bb6f123cd1f", value: String(data.province || "") },
      { fieldDefinitionId: "735326bb-eccd-4d58-8fa0-2bbff51db99e", value: data.dateOfCase ? new Date(data.dateOfCase).toISOString() : "" },
      { fieldDefinitionId: "0902aca4-ce3f-422b-a5f0-9c57c7dbdb26", value: String(data.vehicle.id || "0") },
      { fieldDefinitionId: "85f06b71-61a3-4fa5-a9ff-0bf3a49f2504", value: String(data.vehicle.name || "") },
      { fieldDefinitionId: "2dc4be13-c80b-4157-aadf-8cf67772148d", value: String(data.vehicle.license || "") },
      { fieldDefinitionId: "d820ac80-2167-492b-8c68-c78ed9ae543e", value: String(data.vehicle.registrationNumber || "") },
    ],
    sectionStatuses: [
      {
